...
namespace MoreMountains.Feedbacks
{
	...
	public class MMPositionShaker : MMShaker
	{
		...
		[Tooltip("要进行位置抖动的 `Transform`。若留空，则默认作用于挂载此组件的对象。")]
		...
		[Tooltip("要进行位置抖动的 `RectTransform`。若留空，则默认作用于挂载此组件的对象。")]
