...
namespace MoreMountains.Feedbacks
{
	...
	[FeedbackHelp("此反馈可让你 emit a RotationShake event. This will be caught by MMRotationShakers (on the specified 通道)." +
	              " Rotation 抖动器s, as the name suggests, are used to shake 旋转of a transform, along a direction, with optional noise and other fine control options.")]
	public class MMF_RotationShake : MMF_Feedback
	{
		...
		[Tooltip("摇动过程中变换将移动到的距初始旋转的最大距离")]
