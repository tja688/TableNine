...
namespace MoreMountains.Feedbacks
{
	...
	[FeedbackHelp("此反馈可让你 emit a ScaleShake event. This will be caught by MMScaleShakers (on the specified 通道)." +
	              " Scale 抖动器s, as the name suggests, are used to shake 缩放of a transform, along a direction, with optional noise and other fine control options.")]
