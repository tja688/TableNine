...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("用于驱动 Vector2 弹簧的反馈。")]
	...
	public class MMF_SpringVector2 : MMF_Feedback
	{
		...
		/// 此反馈要控制的 Vector2 弹簧。若这里指定了具体弹簧，则只会作用于它；若留空，则会向所有通道匹配的弹簧广播事件。
		[Tooltip("此反馈要控制的 Vector2 弹簧。若这里指定了具体弹簧，则只会作用于它；若留空，则会向所有通道匹配的弹簧广播事件。")]
