...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_SpringColor : MMF_Feedback
	{
		...
		/// 此反馈要控制的颜色弹簧。若这里指定了具体弹簧，则只会作用于它；若留空，则会向所有通道匹配的弹簧广播事件。
		[Tooltip("此反馈要控制的颜色弹簧。若这里指定了具体弹簧，则只会作用于它；若留空，则会向所有通道匹配的弹簧广播事件。")]
		...
		/// 此 弹簧 要过渡到的新颜色。
		[Tooltip("此 弹簧 要过渡到的新颜色。")]
		public Color MoveToColor = MMColors.Aquamarine;
		/// 要叠加到 弹簧 当前颜色速度上的颜色值，用来制造 弹跳。
		[Tooltip("要叠加到 弹簧 当前颜色速度上的颜色值，用来制造 弹跳。")]
