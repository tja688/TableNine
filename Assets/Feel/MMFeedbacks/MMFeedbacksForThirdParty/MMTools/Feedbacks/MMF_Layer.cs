...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	[AddComponentMenu("")]
	[FeedbackHelp("此反馈可在播放时修改目标 GameObject 的 Layer。")]
	[System.Serializable]
	...
	public class MMF_Layer : MMF_Feedback
	{
		...
		public override string RequiresSetupText { get { return "此反馈必须先指定 TargetGameObject 才能正常工作。你可以在下方进行设置。"; } }
		#endif
