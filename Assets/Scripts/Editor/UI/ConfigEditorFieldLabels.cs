...
public static class ConfigEditorFieldLabels
{
    private static readonly Dictionary<string, (string label, string desc)> Labels =
        new Dictionary<string, (string, string)>
        {
            ...
            ["CommonDeckId"] = ("通用牌组", "该角色可共享使用的牌组 ID。"),
            ["ClassDeckId"] = ("职业牌组", "该角色专属职业牌组 ID。"),

            ["DeckId"] = ("牌组 ID", "牌组自身 ID，或卡牌/规则引用的所属牌组 ID。"),
            ["Faction"] = ("阵营", "玩家牌组或怪物牌组。"),
            ["DeckKind"] = ("牌组类型", "通用、职业、弱精英、强精英或层主。"),
            ["DefaultFaceImage"] = ("默认卡面", "牌组内卡牌默认使用的卡面 Sprite。"),
            ["DefaultBackImage"] = ("默认卡背", "牌组内卡牌默认使用的卡背 Sprite。"),
            ["CardId"] = ("卡牌 ID", "运行时唯一标识。"),
            ["FaceImageOverride"] = ("覆盖卡面", "为空时使用所属牌组默认卡面。"),
            ["BackImageOverride"] = ("覆盖卡背", "为空时使用所属牌组默认卡背。"),
            ...
            ["SourceDeckId"] = ("来源牌组", "本节点怪物规则对应的牌组 ID。"),
